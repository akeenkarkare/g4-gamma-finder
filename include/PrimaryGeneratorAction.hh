...
class PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    ...
    // Source placement (paper geometry): source sits in the X-Y plane at
    // distance fDistance and angle fAngle (clockwise from the detector
    // "front", +Y), firing toward the detector center.
